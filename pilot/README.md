...
Adres nie jest automatycznie zamieniany na współrzędne: plac wskazuje dispo. Jeden załadunek i jeden rozładunek, maks. 48 godzin; do 100 zleceń. Brak edycji i usuwania w tej wersji: błędne zlecenie można wstrzymać; poprawienie zapisanych danych wymaga obsługi administratora. Nakładające się terminy są odrzucane. Brak automatycznych kosztów, pełnej rentowności i przypisania pustych kilometrów między zleceniami. Opóźnione dane starsze niż nakładka wymagają kontrolowanego ponownego importu; puste okna są oznaczane, a nie uznawane za postoje. Eksport zawiera dane lokalizacyjne — przechowuj go prywatnie. Kopię pliku danych należy wykonywać regularnie; eksport nie zastępuje automatycznej kopii zapasowej.
